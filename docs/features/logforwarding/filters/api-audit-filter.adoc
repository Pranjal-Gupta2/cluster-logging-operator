...
== Differences from splunk-audit-exporter

(internal only)

This filter behaves in the same way as https://gitlab.cee.redhat.com:service/splunk-audit-exporter.git.
Effectively it is a port of that code to Vector Remap Language.
