...
func PolicyToVRL(p *loggingv1.APIAudit) (string, error) {
	if p == nil {
		p = &loggingv1.APIAudit{} // Treat missing as empty.
	}
...
// - Go templates and VRL both use {{foo}} for substitution, this can be quotwed as {{"{{"}}foo{{"}}"}} if you want VRL substitution.
