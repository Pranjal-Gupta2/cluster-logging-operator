...
func (in *APIAudit) DeepCopyInto(out *APIAudit) {
	*out = *in
	if in.Rules != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new APIAudit.
func (in *APIAudit) DeepCopy() *APIAudit {
	if in == nil {
		return nil
	}
	out := new(APIAudit)
...
func (in *FilterTypeSpec) DeepCopyInto(out *FilterTypeSpec) {
	*out = *in
	if in.APIAudit != nil {
		in, out := &in.APIAudit, &out.APIAudit
		*out = new(APIAudit)
		(*in).DeepCopyInto(*out)
	}
}
